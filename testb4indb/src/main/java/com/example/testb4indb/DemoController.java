...
public class DemoController {
    ...
    public void createUser(@RequestParam String username, @RequestParam String password) {
        ...
        DemoUser demoUser = DemoUser.builder().username(username).password(password).authorities("USER").build();
    ...
    public void createAdmin(@RequestParam String username, @RequestParam String password) {
        ...
        DemoUser demoUser = DemoUser.builder().username(username).password(password).authorities("ADMIN").build();
        this.demoUserDetailsService.createUser(demoUser);
    }
}
